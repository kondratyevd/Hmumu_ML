...
def GetListOfModels(trainer):
	...
	model_100_D2_50_D2_50_D2 = model_init('model_100_D2_50_D2_50_D2', input_dim, 2048, 200, 'categorical_crossentropy', 'adam')
	x = Dense(100, name = model_100_D2_50_D2_50_D2.name+'_layer_1', activation='relu')(model_100_D2_50_D2_50_D2.inputs)
	x = Dropout(0.2)(x)
	x = Dense(50, name = model_100_D2_50_D2_50_D2.name+'_layer_2', activation='relu')(x)
	x = Dropout(0.2)(x)
	x = Dense(50, name = model_100_D2_50_D2_50_D2.name+'_layer_3', activation='relu')(x)
	x = Dropout(0.2)(x)
	model_100_D2_50_D2_50_D2.outputs = Dense(output_dim, name = model_100_D2_50_D2_50_D2.name+'_output',  activation='softmax')(x)

	model_50_D2_25_D2_25_D2_25_D2 = model_init('model_50_D2_25_D2_25_D2_25_D2', input_dim, 2048, 200, 'categorical_crossentropy', 'adam')
	...
	x = Dropout(0.2)(x)
	model_50_D2_25_D2_25_D2_25_D2.outputs = Dense(output_dim, name = model_50_D2_25_D2_25_D2_25_D2.name+'_output',  activation='softmax')(x)

	model_100_D2_50_D2_50_D2_50_D2 = model_init('model_100_D2_50_D2_50_D2_50_D2', input_dim, 2048, 200, 'categorical_crossentropy', 'adam')
	x = Dense(100, name = model_100_D2_50_D2_50_D2_50_D2.name+'_layer_1', activation='relu')(model_100_D2_50_D2_50_D2_50_D2.inputs)
	x = Dropout(0.2)(x)
	x = Dense(50, name = model_100_D2_50_D2_50_D2_50_D2.name+'_layer_2', activation='relu')(x)
	x = Dropout(0.2)(x)
	x = Dense(50, name = model_100_D2_50_D2_50_D2_50_D2.name+'_layer_3', activation='relu')(x)
	x = Dropout(0.2)(x)
	x = Dense(50, name = model_100_D2_50_D2_50_D2_50_D2.name+'_layer_4', activation='relu')(x)
	x = Dropout(0.2)(x)
	model_100_D2_50_D2_50_D2_50_D2.outputs = Dense(output_dim, name = model_100_D2_50_D2_50_D2_50_D2.name+'_output',  activation='softmax')(x)
