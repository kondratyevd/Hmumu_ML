...
def GetListOfModels(nVar):
	...
	test_model = model_init('TMVA_Keras_test_model', nVar, 2048, 20, 'binary_crossentropy', 'adam')
	...
	test_model.outputs = Dense(2, name = test_model.name+'_output',  activation='sigmoid')(x)


	model_2x20 = model_init('TMVA_Keras_model_2x20', nVar, 2048, 200, 'binary_crossentropy', 'adam')
	...
	model_2x20.outputs = Dense(2, name = model_2x20.name+'_output',  activation='sigmoid')(x)

	model_3x100 = model_init('TMVA_Keras_model_3x100', nVar, 2048, 200, 'binary_crossentropy', 'adam')
	...
	model_3x100.outputs = Dense(2, name = model_3x100.name+'_output',  activation='sigmoid')(x)
