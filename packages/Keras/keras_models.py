...
def GetListOfModels(nVar):
	...
	test_model.outputs = Dense(1, name = test_model.name+'_output',  activation='sigmoid')(x)
	...
	model_2x20.outputs = Dense(1, name = model_2x20.name+'_output',  activation='sigmoid')(x)
	...
	model_3x100.outputs = Dense(1, name = model_3x100.name+'_output', activation='sigmoid')(x)
