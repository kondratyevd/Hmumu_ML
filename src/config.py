...
variables.append(Variable("met.pt"			,"MET",  				"GeV",   	'D', False, 	"nMuons"	,	0	, False	))
variables.append(Variable("met.phi"			,"MET #phi",  			"",   		'D', False, 	"nMuons"	,	-5	, False	))
variables.append(Variable("mht.pt"			,"MHT",  				"GeV",   	'D', False, 	"nMuons"	,	0	, False	))
