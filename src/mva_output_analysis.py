...
dnn_sigloss_1layer.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False, "(sig_prediction>0)&(sig_prediction<1)")
dnn_sigloss_1layer.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False, "(sig_prediction>0)&(sig_prediction<1)")
...
dnn_sigloss_3layers.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False, "(sig_prediction>0)&(sig_prediction<1)")
dnn_sigloss_3layers.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False, "(sig_prediction>0)&(sig_prediction<1)")
dnn_sigloss_3layers.set_lumi(4723.411)
dnn_sigloss_3layers_roc_graph = dnn_sigloss_3layers.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
