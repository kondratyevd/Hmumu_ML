...
dnn_sigloss_1layer.add_sample("tt", "ttbar", "output_t*root", "tree_ttbar", False, True, ROOT.kYellow, False)
dnn_sigloss_1layer.add_sample("dy", "Drell-Yan", "output_t*root", "tree_DY", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer.add_sample("ggh", "ggH", "output_t*root", "tree_ggH", False, False, ROOT.kRed, False)
dnn_sigloss_1layer.add_sample("vbf", "VBF", "output_t*root", "tree_VBF", False, False, ROOT.kViolet-1, False)
# dnn_sigloss_1layer.add_sample("data", "Data 2017 (40.5/fb)", "output_Data.root", "tree_Data", True, False, ROOT.kBlack)
dnn_sigloss_1layer.set_lumi(4723.411)
dnn_sigloss_1layer_roc_graph = dnn_sigloss_1layer.plot_roc("sig_prediction)", 500, 1, 3, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
...
dnn_sigloss_3layers.add_sample("tt", "ttbar", "output_t*root", "tree_ttbar", False, True, ROOT.kYellow, False)
dnn_sigloss_3layers.add_sample("dy", "Drell-Yan", "output_t*root", "tree_DY", False, True, ROOT.kOrange-3, False)
dnn_sigloss_3layers.add_sample("ggh", "ggH", "output_t*root", "tree_ggH", False, False, ROOT.kRed, False)
dnn_sigloss_3layers.add_sample("vbf", "VBF", "output_t*root", "tree_VBF", False, False, ROOT.kViolet-1, False)
# dnn_sigloss_3layers.add_sample("data", "Data 2017 (40.5/fb)", "output_Data.root", "tree_Data", True, False, ROOT.kBlack)
dnn_sigloss_3layers.set_lumi(4723.411)
dnn_sigloss_3layers_roc_graph = dnn_sigloss_3layers.plot_roc("sig_prediction)", 500, 1, 3, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
