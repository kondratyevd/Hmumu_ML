...
dnn_multi_hiStat_m120To130_1.plot("mass", 10, 110, 150, label="shapes", draw=True, shapes=True)
...
dnn_multi_hiStat_m120To130_repeated_1.plot("mass", 10, 110, 150, label="shapes", draw=True, shapes=True)
