...
dnn_sigloss_1layer_reg001_roc = a.RocCurve(dnn_sigloss_1layer_reg001_roc_graph, "dnn_sigloss_1layer_reg001", "DNN sigloss 1 layer reg l=0.001", ROOT.kOrange, 1)
...
dnn_sigloss_1layer_reg005_roc = a.RocCurve(dnn_sigloss_1layer_reg005_roc_graph, "dnn_sigloss_1layer_reg005", "DNN sigloss 1 layer reg l=0.005", ROOT.kOrange, 1)
