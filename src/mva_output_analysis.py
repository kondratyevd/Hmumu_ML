    ...
    def plot_width_vs_score(self, score, source, name, title, nBins, color, markerStyle, process = "ggH"):
        ...
        for i in range(nBins):
            ...
            if "ggH" in process:
                ...
                sample_bin = source.add_sample("vbf", "VBF", "output_t*root", "tree_VBF", False, False, ROOT.kViolet-1, True, "(%s>%f)&(%s<%f)"%(score, cut_lo, score, cut_hi))
...
dnn_ucsd_files_resweights = a.add_mva_source("DNN_ucsd_files_resweights_inclusive_resweights", "DNN inclusive_resweights", "/home/dkondra/tmp/Run_2019-06-03_10-21-20//Keras/model_resweights/root/")
...
nBins = 50
gr1 = a.plot_width_vs_score(score, dnn_ucsd_files, "dnn_ucsd_files", "DNN inclusive", nBins, ROOT.kRed, 20, process = "ggH")
gr2 = a.plot_width_vs_score(score, dnn_ucsd_files_resweights, "dnn_ucsd_files", "DNN inclusive resweights", nBins, ROOT.kBlue, 20, process = "ggH")
gr3 = a.plot_width_vs_score(score, bdt_ucsd_all, "bdt_ucsd_all", "BDT inclusive resweights", nBins, ROOT.kBlack, 20, process = "ggH")
