            ...
            for i in range(1, nBins):
                ...
                for h in self.signal_hists:
                    if i is nBins:
                        ...
                        sig_above = sig_above + h.Integral(i+1 ,nBins)
...
dnn_sigloss_1layer_roc_graph = dnn_sigloss_1layer.plot_roc("sig_prediction", 500, 0, 1, [0.5])
...
# dnn_sigloss_1layer_reg001 = a.add_mva_source("DNN_sigloss_1layer_reg001", "DNN sigloss 1 layer reg l=0.001", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-10_16-14-38//Keras/model_sigloss/root/")
# dnn_sigloss_1layer_reg001.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
...
# dnn_sigloss_1layer_reg002 = a.add_mva_source("DNN_sigloss_1layer_reg002", "DNN sigloss 1 layer reg l=0.002", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-10_16-32-32//Keras/model_sigloss/root/")
# dnn_sigloss_1layer_reg002.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
...
dnn_sigloss_1layer_reg0025 = a.add_mva_source("DNN_sigloss_1layer_reg0025", "DNN sigloss 1 layer reg l=0.0025", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-11_17-27-51//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg0025.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg0025.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
dnn_sigloss_1layer_reg0025.set_lumi(4723.411)
# dnn_sigloss_1layer_reg0025_roc_graph = dnn_sigloss_1layer_reg0025.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
dnn_sigloss_1layer_reg0025_roc_graph = dnn_sigloss_1layer_reg0025.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
dnn_sigloss_1layer_reg0025_roc = a.RocCurve(dnn_sigloss_1layer_reg0025_roc_graph, "dnn_sigloss_1layer_reg0025", "DNN sigloss 1 layer reg l=0.0025", ROOT.kYellow, 1)
roc_to_compare.append(dnn_sigloss_1layer_reg0025_roc)

dnn_sigloss_1layer_reg0029 = a.add_mva_source("DNN_sigloss_1layer_reg0029", "DNN sigloss 1 layer reg l=0.0029", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-12_10-17-55//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg0029.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg0029.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
dnn_sigloss_1layer_reg0029.set_lumi(4723.411)
# dnn_sigloss_1layer_reg0029_roc_graph = dnn_sigloss_1layer_reg0029.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
dnn_sigloss_1layer_reg0029_roc_graph = dnn_sigloss_1layer_reg0029.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
dnn_sigloss_1layer_reg0029_roc = a.RocCurve(dnn_sigloss_1layer_reg0029_roc_graph, "dnn_sigloss_1layer_reg0029", "DNN sigloss 1 layer reg l=0.0029", ROOT.kOrange, 1)
roc_to_compare.append(dnn_sigloss_1layer_reg0029_roc)

dnn_sigloss_1layer_reg003 = a.add_mva_source("DNN_sigloss_1layer_reg003", "DNN sigloss 1 layer reg l=0.003", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-11_10-50-48//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg003.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
...
dnn_sigloss_1layer_reg003_roc = a.RocCurve(dnn_sigloss_1layer_reg003_roc_graph, "dnn_sigloss_1layer_reg003", "DNN sigloss 1 layer reg l=0.003", ROOT.kRed, 1)
roc_to_compare.append(dnn_sigloss_1layer_reg003_roc)

dnn_sigloss_1layer_reg00301 = a.add_mva_source("DNN_sigloss_1layer_reg00301", "DNN sigloss 1 layer reg l=0.00301", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-12_13-40-23//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg00301.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg00301.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
dnn_sigloss_1layer_reg00301.set_lumi(4723.411)
# dnn_sigloss_1layer_reg00301_roc_graph = dnn_sigloss_1layer_reg00301.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
dnn_sigloss_1layer_reg00301_roc_graph = dnn_sigloss_1layer_reg00301.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
dnn_sigloss_1layer_reg00301_roc = a.RocCurve(dnn_sigloss_1layer_reg00301_roc_graph, "dnn_sigloss_1layer_reg00301", "DNN sigloss 1 layer reg l=0.00301", ROOT.kGreen, 1)
roc_to_compare.append(dnn_sigloss_1layer_reg00301_roc)

dnn_sigloss_1layer_reg0031 = a.add_mva_source("DNN_sigloss_1layer_reg0031", "DNN sigloss 1 layer reg l=0.0031", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-12_10-18-16//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg0031.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg0031.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
dnn_sigloss_1layer_reg0031.set_lumi(4723.411)
# dnn_sigloss_1layer_reg0031_roc_graph = dnn_sigloss_1layer_reg0031.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
dnn_sigloss_1layer_reg0031_roc_graph = dnn_sigloss_1layer_reg0031.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
dnn_sigloss_1layer_reg0031_roc = a.RocCurve(dnn_sigloss_1layer_reg0031_roc_graph, "dnn_sigloss_1layer_reg0031", "DNN sigloss 1 layer reg l=0.0031", ROOT.kBlue, 1)
roc_to_compare.append(dnn_sigloss_1layer_reg0031_roc)


dnn_sigloss_1layer_new = a.add_mva_source("DNN_sigloss_1layer_new", "DNN sigloss 1 layer", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-20_18-11-23//Keras/model_sigloss_multi/root/")
...
dnn_sigloss_1layer_new_roc = a.RocCurve(dnn_sigloss_1layer_new_roc_graph, "dnn_sigloss_1layer_new", "DNN sigloss 1 layer", ROOT.kBlack, 4)
roc_to_compare.append(dnn_sigloss_1layer_new_roc)

dnn_sigloss_1layer_reg002_new = a.add_mva_source("DNN_sigloss_1layer_reg002_new", "DNN sigloss 1 layer reg l=0.002", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-20_18-15-28//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg002_new.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg002_new.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
...
dnn_sigloss_1layer_reg003_new.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg003_new.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
dnn_sigloss_1layer_reg003_new.set_lumi(4723.411)
# dnn_sigloss_1layer_reg003_new_roc_graph = dnn_sigloss_1layer_reg003_new.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
dnn_sigloss_1layer_reg003_new_roc_graph = dnn_sigloss_1layer_reg003_new.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
dnn_sigloss_1layer_reg003_new_roc = a.RocCurve(dnn_sigloss_1layer_reg003_new_roc_graph, "dnn_sigloss_1layer_reg003_new", "DNN sigloss 1 layer reg l=0.003", ROOT.kRed, 4)
roc_to_compare.append(dnn_sigloss_1layer_reg003_new_roc)

dnn_sigloss_1layer_reg004_new = a.add_mva_source("DNN_sigloss_1layer_reg004_new", "DNN sigloss 1 layer reg l=0.004", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-20_15-48-00//Keras/model_sigloss/root/")
dnn_sigloss_1layer_reg004_new.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer_reg004_new.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
dnn_sigloss_1layer_reg004_new.set_lumi(4723.411)
# dnn_sigloss_1layer_reg004_new_roc_graph = dnn_sigloss_1layer_reg004_new.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
dnn_sigloss_1layer_reg004_new_roc_graph = dnn_sigloss_1layer_reg004_new.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
dnn_sigloss_1layer_reg004_new_roc = a.RocCurve(dnn_sigloss_1layer_reg004_new_roc_graph, "dnn_sigloss_1layer_reg004_new", "DNN sigloss 1 layer reg l=0.004", ROOT.kOrange, 4)
roc_to_compare.append(dnn_sigloss_1layer_reg004_new_roc)

# dnn_sigloss_1layer_reg0035 = a.add_mva_source("DNN_sigloss_1layer_reg0035", "DNN sigloss 1 layer reg l=0.0035", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-11_17-28-11//Keras/model_sigloss/root/")
# dnn_sigloss_1layer_reg0035.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_reg0035.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_reg0035.set_lumi(4723.411)
# # dnn_sigloss_1layer_reg0035_roc_graph = dnn_sigloss_1layer_reg0035.plot_roc("log(((1-2*pow(10,-10))*sig_prediction+pow(10,-10))/(1-((1-2*pow(10,-10))*sig_prediction+pow(10,-10))))", 500, -100, 100, [0.5])
# dnn_sigloss_1layer_reg0035_roc_graph = dnn_sigloss_1layer_reg0035.plot_roc("sig_prediction", 10000, 0, 1, [0.5])
# dnn_sigloss_1layer_reg0035_roc = a.RocCurve(dnn_sigloss_1layer_reg0035_roc_graph, "dnn_sigloss_1layer_reg0035", "DNN sigloss 1 layer reg l=0.0035", ROOT.kCyan, )
# roc_to_compare.append(dnn_sigloss_1layer_reg0035_roc)

# dnn_sigloss_1layer_reg004 = a.add_mva_source("DNN_sigloss_1layer_reg004", "DNN sigloss 1 layer reg l=0.004", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-11_10-51-13//Keras/model_sigloss/root/")
# dnn_sigloss_1layer_reg004.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
...
# dnn_sigloss_1layer_reg004_roc = a.RocCurve(dnn_sigloss_1layer_reg004_roc_graph, "dnn_sigloss_1layer_reg004", "DNN sigloss 1 layer reg l=0.004", ROOT.kBlue, 1)
# roc_to_compare.append(dnn_sigloss_1layer_reg004_roc)

# dnn_sigloss_1layer_reg005 = a.add_mva_source("DNN_sigloss_1layer_reg005", "DNN sigloss 1 layer reg l=0.005", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-10_12-22-48//Keras/model_sigloss/root/")
# dnn_sigloss_1layer_reg005.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
...
# dnn_sigloss_1layer_reg005_roc = a.RocCurve(dnn_sigloss_1layer_reg005_roc_graph, "dnn_sigloss_1layer_reg005", "DNN sigloss 1 layer reg l=0.005", ROOT.kViolet, 1)
# roc_to_compare.append(dnn_sigloss_1layer_reg005_roc)

# dnn_sigloss_1layer_reg01 = a.add_mva_source("DNN_sigloss_1layer_reg01", "DNN sigloss 1 layer reg l=0.01", "/home/dkondra/tmp/Run_2019-06-07_18-04-30//Keras/model_sigloss/root/")
# dnn_sigloss_1layer_reg01.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
...
# dnn_sigloss_1layer_reg01_roc = a.RocCurve(dnn_sigloss_1layer_reg01_roc_graph, "dnn_sigloss_1layer_reg01", "DNN sigloss 1 layer reg l=0.01", ROOT.kViolet, 2)
...
# dnn_sigloss_1layer_asimov = a.add_mva_source("DNN_sigloss_1layer_asimov", "DNN sigloss 1 layer asimov", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-12_12-04-40//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_roc_graph = dnn_sigloss_1layer_asimov.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_roc_graph = dnn_sigloss_1layer_asimov.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_roc = a.RocCurve(dnn_sigloss_1layer_asimov_roc_graph, "dnn_sigloss_1layer_asimov", "DNN sigloss 1 layer asimov", ROOT.kViolet, 2)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_roc)

# dnn_sigloss_1layer_asimov_reg0001 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg0001", "DNN sigloss 1 layer asimov reg l=0.0001", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-14_10-18-09//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg0001.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg0001.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg0001.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg0001_roc_graph = dnn_sigloss_1layer_asimov_reg0001.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0001_roc_graph = dnn_sigloss_1layer_asimov_reg0001.plot_roc("sig_prediction", 500, 0, 1, [0.5])
...
# dnn_sigloss_1layer_asimov_reg0004 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg0004", "DNN sigloss 1 layer asimov reg l=0.0004", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-14_17-07-42//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg0004.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg0004.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg0004.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg0004_roc_graph = dnn_sigloss_1layer_asimov_reg0004.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0004_roc_graph = dnn_sigloss_1layer_asimov_reg0004.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg0004_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg0004_roc_graph, "dnn_sigloss_1layer_asimov_reg0004", "DNN sigloss 1 layer asimov reg l=0.0004", ROOT.kBlue, 2)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg0004_roc)

# dnn_sigloss_1layer_asimov_reg0005 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg0005", "DNN sigloss 1 layer asimov reg l=0.0005", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-14_17-08-02//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg0005.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg0005.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg0005.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg0005_roc_graph = dnn_sigloss_1layer_asimov_reg0005.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0005_roc_graph = dnn_sigloss_1layer_asimov_reg0005.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg0005_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg0005_roc_graph, "dnn_sigloss_1layer_asimov_reg0005", "DNN sigloss 1 layer asimov reg l=0.0005", ROOT.kBlue, 3)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg0005_roc)

# dnn_sigloss_1layer_asimov_reg0006 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg0006", "DNN sigloss 1 layer asimov reg l=0.0006", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-15_21-14-49//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg0006.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg0006.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg0006.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg0006_roc_graph = dnn_sigloss_1layer_asimov_reg0006.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0006_roc_graph = dnn_sigloss_1layer_asimov_reg0006.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg0006_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg0006_roc_graph, "dnn_sigloss_1layer_asimov_reg0006", "DNN sigloss 1 layer asimov reg l=0.0006", ROOT.kOrange, 2)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg0006_roc)

# dnn_sigloss_1layer_asimov_reg0007 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg0007", "DNN sigloss 1 layer asimov reg l=0.0007", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-15_21-15-20//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg0007.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg0007.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg0007.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg0007_roc_graph = dnn_sigloss_1layer_asimov_reg0007.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0007_roc_graph = dnn_sigloss_1layer_asimov_reg0007.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg0007_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg0007_roc_graph, "dnn_sigloss_1layer_asimov_reg0007", "DNN sigloss 1 layer asimov reg l=0.0007", ROOT.kOrange, 3)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg0007_roc)

# dnn_sigloss_1layer_asimov_reg00065 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg00065", "DNN sigloss 1 layer asimov reg l=0.00065", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-16_12-05-44//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg00065.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg00065.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg00065.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg00065_roc_graph = dnn_sigloss_1layer_asimov_reg00065.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg00065_roc_graph = dnn_sigloss_1layer_asimov_reg00065.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg00065_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg00065_roc_graph, "dnn_sigloss_1layer_asimov_reg00065", "DNN sigloss 1 layer asimov reg l=0.00065", ROOT.kOrange, 2)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg00065_roc)

# dnn_sigloss_1layer_asimov_reg00075 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg00075", "DNN sigloss 1 layer asimov reg l=0.00075", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-16_12-06-12//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg00075.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg00075.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg00075.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg00075_roc_graph = dnn_sigloss_1layer_asimov_reg00075.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg00075_roc_graph = dnn_sigloss_1layer_asimov_reg00075.plot_roc("sig_prediction", 500, 0, 1, [0.5])
...
# # dnn_sigloss_1layer_asimov_reg0008_roc_graph = dnn_sigloss_1layer_asimov_reg0008.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0008_roc_graph = dnn_sigloss_1layer_asimov_reg0008.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg0008_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg0008_roc_graph, "dnn_sigloss_1layer_asimov_reg0008", "DNN sigloss 1 layer asimov reg l=0.0008", ROOT.kViolet, 2)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg0008_roc)

# dnn_sigloss_1layer_asimov_reg0009 = a.add_mva_source("DNN_sigloss_1layer_asimov_reg0009", "DNN sigloss 1 layer asimov reg l=0.0009", "/scratch/gilbreth/dkondra/ML_output/Run_2019-06-16_15-24-02//Keras/model_sigloss_asimov/root/")
# dnn_sigloss_1layer_asimov_reg0009.add_sample("bkg", "Background", "output_t*root", "tree_background", False, True, ROOT.kOrange-3, False)
# dnn_sigloss_1layer_asimov_reg0009.add_sample("sig", "Signal", "output_t*root", "tree_signal", False, False, ROOT.kRed, False)
# dnn_sigloss_1layer_asimov_reg0009.set_lumi(4723.411)
# # dnn_sigloss_1layer_asimov_reg0009_roc_graph = dnn_sigloss_1layer_asimov_reg0009.plot_roc("log(((1-2*pow(10,-8))*sig_prediction+pow(10,-8))/(1-((1-2*pow(10,-8))*sig_prediction+pow(10,-8))))", 10000, -100, 100, [0.5])
# dnn_sigloss_1layer_asimov_reg0009_roc_graph = dnn_sigloss_1layer_asimov_reg0009.plot_roc("sig_prediction", 500, 0, 1, [0.5])
# dnn_sigloss_1layer_asimov_reg0009_roc = a.RocCurve(dnn_sigloss_1layer_asimov_reg0009_roc_graph, "dnn_sigloss_1layer_asimov_reg0009", "DNN sigloss 1 layer asimov reg l=0.0009", ROOT.kViolet, 3)
# roc_to_compare.append(dnn_sigloss_1layer_asimov_reg0009_roc)
