...
dnn_sigloss_1layer_roc_graph = dnn_sigloss_1layer.plot_roc("log(((1-2*pow(10,-9))*sig_prediction+pow(10,-9))/(1-((1-2*pow(10,-9))*sig_prediction+pow(10,-9))))", 500, -100, 100, [0.5])
