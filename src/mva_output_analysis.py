...
bdt_raffaele_all.add_sample("vv2016", "VV", "/*/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False)
...
bdt_raffaele_all.add_sample("tt2016", "ttbar", "/*/tree_top.root", "tree", False, True, ROOT.kYellow, False)
...
bdt_raffaele_all.add_sample("dy2016", "Drell-Yan", "/*/tree_DY.root", "tree", False, True, ROOT.kOrange-3, False)
...
bdt_raffaele_all.add_sample("ggh2016", "ggH", "/2016/tree_ggH.root", "tree", False, False, ROOT.kRed, False)
bdt_raffaele_all.add_sample("ggh2017", "ggH", "/2017/tree_ggH.root", "tree", False, False, ROOT.kRed, False)
bdt_raffaele_all.add_sample("ggh2018", "ggH", "/2018/tree_ggH.root", "tree", False, False, ROOT.kRed, False)
bdt_raffaele_all.add_sample("vbf2016", "VBF", "/2016/tree_VBF.root", "tree", False, False, ROOT.kViolet-1, False)
