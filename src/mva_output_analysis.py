...
dnn_sigloss_1layer_roc_graph = dnn_sigloss_1layer.plot_roc("log(((1-2*pow(10,-7))*sig_prediction+pow(10,-7))/(1-((1-2*pow(10,-7))*sig_prediction+pow(10,-7))))", 500, -100, 100, [0.5])
