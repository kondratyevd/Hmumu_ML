...
dnn_ucsd_files.add_sample("tt", "ttbar", "output_t*root", "tree_ttbar", False, True, ROOT.kYellow, True)
dnn_ucsd_files.add_sample("dy", "Drell-Yan", "output_t*root", "tree_DY", False, True, ROOT.kOrange-3, True)
dnn_ucsd_files.add_sample("ggh", "ggH", "output_t*root", "tree_ggH", False, False, ROOT.kRed, True)
dnn_ucsd_files.add_sample("vbf", "VBF", "output_t*root", "tree_BF", False, False, ROOT.kViolet-1, True)
...
# bdt_ucsd_all = a.add_mva_source("BDT_ucsd_incl", "BDT UCSD inclusive", "/mnt/hadoop/store/user/dkondrat/UCSD_files/")
# bdt_ucsd_all.add_sample("vv2016", "VV", "/2016/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False)
# bdt_ucsd_all.add_sample("vv2017", "VV", "/2017/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False)
# bdt_ucsd_all.add_sample("vv2018", "VV", "/2018/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False)
# bdt_ucsd_all.add_sample("tt2016", "ttbar", "/2016/tree_top.root", "tree", False, True, ROOT.kYellow, False)
...
# bdt_ucsd_all.add_sample("dy2017", "Drell-Yan", "/2017/tree_DY.root", "tree", False, True, ROOT.kOrange-3, False)
# bdt_ucsd_all.add_sample("dy2018", "Drell-Yan", "/2018/tree_DY.root", "tree", False, True, ROOT.kOrange-3, False)
# bdt_ucsd_all.add_sample("ggh2016", "ggH", "/2016/tree_ggH.root", "tree", False, False, ROOT.kRed, False, "3")
# bdt_ucsd_all.add_sample("vbf2016", "VBF", "/2016/tree_VBF.root", "tree", False, False, ROOT.kViolet-1, False, "3")

# bdt_ucsd_all.set_lumi(4723.411)
# bdt_ucsd_all_roc_graph = bdt_ucsd_all.plot_roc("bdtucsd_inclusive", 200, -1, 1, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
# bdt_ucsd_all_roc = a.RocCurve(bdt_ucsd_all_roc_graph, "BDT_ucsd_incl", "BDT UCSD inclusive", ROOT.kBlue, 2)
# roc_to_compare.append(bdt_ucsd_all_roc)
