...
dnn_ucsd_files = a.add_mva_source("DNN_ucsd_files_inclusive", "DNN ucsd files - inclusive", "/home/dkondra/tmp/Run_2019-05-26_19-22-23//Keras/model_50_D2_25_D2_25_D2/root/")
...
dnn_ucsd_files_roc = a.RocCurve(dnn_ucsd_files_roc_graph, "dnn_ucsd_files_inclusive", "DNN ucsd files - inclusive", ROOT.kBlack, 1)
roc_to_compare.append(dnn_ucsd_files_roc)

dnn_ucsd_files = a.add_mva_source("DNN_ucsd_files_01jet", "DNN ucsd files - 01jet", "/home/dkondra/tmp/Run_2019-05-26_19-32-20//Keras/model_50_D2_25_D2_25_D2/root/")
dnn_ucsd_files.add_sample("tt", "ttbar", "output_t*root", "tree_ttbar", False, True, ROOT.kYellow, False)
dnn_ucsd_files.add_sample("dy", "Drell-Yan", "output_t*root", "tree_DY", False, True, ROOT.kOrange-3, False)
dnn_ucsd_files.add_sample("ggh", "ggH", "output_t*root", "tree_ggH", False, False, ROOT.kRed, False)
dnn_ucsd_files.add_sample("vbf", "VBF", "output_t*root", "tree_VBF", False, False, ROOT.kViolet-1, False)
...
dnn_ucsd_files.set_lumi(4723.411)
dnn_ucsd_files_roc_graph = dnn_ucsd_files.plot_roc("ggH_prediction+VBF_prediction+(1-DY_prediction)+(1-ttbar_prediction)", 500, 1, 3, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
dnn_ucsd_files_roc = a.RocCurve(dnn_ucsd_files_roc_graph, "dnn_ucsd_files_01jet", "DNN ucsd files - 01jet", ROOT.kBlue, 1)
roc_to_compare.append(dnn_ucsd_files_roc)

dnn_ucsd_files = a.add_mva_source("DNN_ucsd_files_2jet", "DNN ucsd files - 2jet", "/home/dkondra/tmp/Run_2019-05-26_19-32-26//Keras/model_50_D2_25_D2_25_D2/root/")
dnn_ucsd_files.add_sample("tt", "ttbar", "output_t*root", "tree_ttbar", False, True, ROOT.kYellow, False)
dnn_ucsd_files.add_sample("dy", "Drell-Yan", "output_t*root", "tree_DY", False, True, ROOT.kOrange-3, False)
dnn_ucsd_files.add_sample("ggh", "ggH", "output_t*root", "tree_ggH", False, False, ROOT.kRed, False)
dnn_ucsd_files.add_sample("vbf", "VBF", "output_t*root", "tree_VBF", False, False, ROOT.kViolet-1, False)
...
dnn_ucsd_files.set_lumi(4723.411)
dnn_ucsd_files_roc_graph = dnn_ucsd_files.plot_roc("ggH_prediction+VBF_prediction+(1-DY_prediction)+(1-ttbar_prediction)", 500, 1, 3, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
dnn_ucsd_files_roc = a.RocCurve(dnn_ucsd_files_roc_graph, "dnn_ucsd_files_2jet", "DNN ucsd files - 2jet", ROOT.kRed, 1)
roc_to_compare.append(dnn_ucsd_files_roc)



# bdt_ucsd_all = a.add_mva_source("BDT_ucsd_all_2jet_mjjcut", "BDT UCSD 2jet bveto mjj<500", "/mnt/hadoop/store/user/dkondrat/UCSD_files/")
# bdt_ucsd_all.add_sample("vv2016", "VV", "/2016/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("vv2017", "VV", "/2017/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("vv2018", "VV", "/2018/tree_VV.root", "tree", False, True, ROOT.kGreen-1, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("tt2016", "ttbar", "/2016/tree_top.root", "tree", False, True, ROOT.kYellow, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("tt2017", "ttbar", "/2017/tree_top.root", "tree", False, True, ROOT.kYellow, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("tt2018", "ttbar", "/2018/tree_top.root", "tree", False, True, ROOT.kYellow, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("dy2016", "Drell-Yan", "/2016/tree_DY.root", "tree", False, True, ROOT.kOrange-3, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("dy2017", "Drell-Yan", "/2017/tree_DY.root", "tree", False, True, ROOT.kOrange-3, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("dy2018", "Drell-Yan", "/2018/tree_DY.root", "tree", False, True, ROOT.kOrange-3, False, "(mjj<500)")
# bdt_ucsd_all.add_sample("ggh2016", "ggH", "/2016/tree_ggH.root", "tree", False, False, ROOT.kRed, False, "3.8*(mjj<500)")
# bdt_ucsd_all.add_sample("vbf2016", "VBF", "/2016/tree_VBF.root", "tree", False, False, ROOT.kViolet-1, False, "3.8*(mjj<500)")

# bdt_ucsd_all.set_lumi(4723.411)
# bdt_ucsd_all_roc_graph = bdt_ucsd_all.plot_roc("bdtucsd_2jet_bveto", 200, -1, 1, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
# bdt_ucsd_all_roc = a.RocCurve(bdt_ucsd_all_roc_graph, "bdt_ucsd_all_2jet_mjjcut", "BDT UCSD 2jet mjj<500", ROOT.kRed, 2)
# roc_to_compare.append(bdt_ucsd_all_roc)
