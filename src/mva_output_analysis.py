...
dnn_sigloss_1layer.add_sample("bkg", "Background", "output_t*root", "tree_bkg", False, True, ROOT.kOrange-3, False)
dnn_sigloss_1layer.add_sample("sig", "Signal", "output_t*root", "tree_sig", False, False, ROOT.kRed, False)
...
dnn_sigloss_3layers.add_sample("bkg", "Background", "output_t*root", "tree_bkg", False, True, ROOT.kOrange-3, False)
dnn_sigloss_3layers.add_sample("sig", "Signal", "output_t*root", "tree_sig", False, False, ROOT.kRed, False)
