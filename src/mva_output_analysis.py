...
dnn_sigloss_1layer_roc_graph = dnn_sigloss_1layer.plot_roc("sig_prediction", 500, -0.01, 1.01, [0.5])
...
dnn_sigloss_3layers_roc_graph = dnn_sigloss_3layers.plot_roc("sig_prediction", 500, -0.01, 1.01, [0.5])
