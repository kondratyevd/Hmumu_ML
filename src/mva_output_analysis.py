...
dnn_multi_hiStat_m120to130_CS_roc_graph = dnn_multi_hiStat_m120to130_CS.plot_roc("ggH_prediction+VBF_prediction+(1-DY_prediction)+(1-ttbar_prediction)", 5000, 1, 3, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
...
bdt_ucsd_hiStat_cs_roc_graph = bdt_ucsd_hiStat_cs.plot_roc("MVA", 5000, -1, 1, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
...
# # Option 3.3
# dnn_multi_hiStat_m120to130_CS1 = a.add_mva_source("DNN_Multi_hiStat_m120to130_CS1", "DNN_Multi_hiStat_m120to130_CS1", "/scratch/gilbreth/dkondra/ML_output/Run_2019-04-22_15-21-42//Keras_multi/model_50_D2_25_D2_25_D2/root/")
...
dnn_multi_hiStat_m120to130_CS_noSingleMu_roc_graph = dnn_multi_hiStat_m120to130_CS_noSingleMu.plot_roc("ggH_prediction+VBF_prediction+(1-DY_prediction)+(1-ttbar_prediction)", 5000, 1, 3, [0.08, 0.39, 0.61, 0.76, 0.91, 0.95])
