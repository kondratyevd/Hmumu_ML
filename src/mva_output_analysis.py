...
dnn_sigloss_1layer_roc_graph = dnn_sigloss_1layer.plot_roc("log(((1-2*0.0000001)*sig_prediction+0.0000001)/(1-((1-2*0.0000001)*sig_prediction+0.0000001)))", 500, -100, 100, [0.5])
