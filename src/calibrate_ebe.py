...
def fit_zpeak(cat_name, tree, out_path, cut, isData=False):
    ...
    w.factory("RooDCBShape::dcb_%s(mass, %s_mean[90, 85,95], %s_sigma[2,0,5], %s_alphaL[2,0,25] , %s_alphaR[2,0,25], %s_nL[1.5,0,25], %s_nR[1.5,0,25])"%(cat_name,cat_name,cat_name,cat_name,cat_name,cat_name,cat_name))
