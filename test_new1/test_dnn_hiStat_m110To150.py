...
c.add_dir_to_category(ggH_2017_powheg.name, ggH_2017_powheg.path+"tuple_9*", ggH_2017_powheg.xSec, c.ggh_label)

c.add_category(c.vbf_label, True)
c.add_dir_to_category(VBF_2017_powheg.name, VBF_2017_powheg.path+"tuple_9*", VBF_2017_powheg.xSec, c.vbf_label)
...
c.add_dir_to_category(tt_ll_POW_2017.name, tt_ll_POW_2017.path+"tuple_9*", tt_ll_POW_2017.xSec, c.tt_label)
