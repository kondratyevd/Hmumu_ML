...
c.add_variable("Alt$(jets.eta[0],-5)",1)
c.add_variable("Alt$(jets.eta[1],-5)",1)
c.add_variable("Alt$(jetPairs.dEta[0],-1)",1)
c.add_variable("Alt$(jetPairs.dEta[1],-1)",1)
c.add_variable("Alt$(jetPairs.mass[0],0)",1)
c.add_variable("Alt$(jetPairs.mass[1],0)",1)
