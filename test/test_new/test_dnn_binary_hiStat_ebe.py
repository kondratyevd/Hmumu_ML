...
c = Framework()
c.label = "bdt_dnn_binary_hiStat_ebe"
comment = "Option 10: binary DNN, with even-by-event mass res., ZJets_AMC_hiStat ( mass 105-160 )"	
...
c.add_dir_to_category(ZJets_aMC_2017_hiStat.name, ZJets_aMC_2017_hiStat.path, ZJets_aMC_2017_hiStat.xSec, c.bkg_label)
...
c.add_variable("muPairs.mass_res",			1)
###############################################
