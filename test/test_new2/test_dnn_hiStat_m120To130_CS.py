...
comment = "Option 2.4: 4-class DNN, mass window [120, 130], w/o even-by-event mass res., ZJets_AMC_hiStat ( mass 105-160 ), with CS variables - balanced"	
...
c.add_dir_to_category(ggH_2017_powheg.name, ggH_2017_powheg.path, ggH_2017_powheg.xSec, c.ggh_label, repeat=4)

c.add_category(c.vbf_label, True)
c.add_dir_to_category(VBF_2017_powheg.name, VBF_2017_powheg.path, VBF_2017_powheg.xSec, c.vbf_label, repeat=6)
