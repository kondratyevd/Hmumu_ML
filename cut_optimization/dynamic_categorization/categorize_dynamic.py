...
if args.option is "0": # ucsd categories
    ...
    my_best_2jet_bveto_mjjcut = {
        "cat0": "(bdtucsd_2jet_bveto>-1)&(bdtucsd_2jet_bveto<-0.69)&(njets>=2)&(mjj<450)",
        "cat1": "(bdtucsd_2jet_bveto>-0.69)&(bdtucsd_2jet_bveto<-0.47)&(njets>=2)&(mjj<450)",
        "cat3": "(bdtucsd_2jet_bveto>-0.47)&(bdtucsd_2jet_bveto<1)&(njets>=2)&(mjj<450)",
        # "cat4": "(bdtucsd_2jet_bveto>-0.03)&(bdtucsd_2jet_bveto<0.5)&(njets>=2)&(mjj<450)",
        # "cat5": "(bdtucsd_2jet_bveto>0.5)&(bdtucsd_2jet_bveto<1)&(njets>=2)&(mjj<450)",   
    }
