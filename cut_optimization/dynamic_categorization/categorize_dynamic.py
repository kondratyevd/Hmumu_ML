...
if args.option is "0": # ucsd categories
    ...
    my_best_2jet_bveto_mjjcut = {
        "cat0": "(bdtucsd_2jet_bveto>-1)&(bdtucsd_2jet_bveto<-0.76)&(njets>=2)&(mjj<450)",
        "cat1": "(bdtucsd_2jet_bveto>-0.76)&(bdtucsd_2jet_bveto<-0.28)&(njets>=2)&(mjj<450)",
        "cat3": "(bdtucsd_2jet_bveto>-0.28)&(bdtucsd_2jet_bveto<0.02)&(njets>=2)&(mjj<450)",
        "cat4": "(bdtucsd_2jet_bveto>0.02)&(bdtucsd_2jet_bveto<0.27)&(njets>=2)&(mjj<450)",
        "cat5": "(bdtucsd_2jet_bveto>0.27)&(bdtucsd_2jet_bveto<0.61)&(njets>=2)&(mjj<450)",   
        "cat6": "(bdtucsd_2jet_bveto>0.61)&(bdtucsd_2jet_bveto<1)&(njets>=2)&(mjj<450)",                
    }
