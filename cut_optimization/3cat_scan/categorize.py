...
for i in range(18, 23):
    for j in range(i):
        ...
        create_datacard(bins, args.sig_input_path, args.sig_tree, args.data_input_path, args.data_tree, args.output_path, "datacard_3cat_%i_%i"%(j+1, i+1), "workspace_3cat_%i_%i"%(j+1, i+1), args.lumi, nuis=args.nuis, res_unc_val=args.nuis_val, smodel=args.smodel)