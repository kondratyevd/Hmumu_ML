...
plot_014_mva = SignPlot(-1, 1, 100, "BDT_1_4_mva", "BDT 1 cut tune2, only mva", "output/scan_0.1.4/",  "higgsCombine_dnn_option0.1.4_mva_", ".Significance.mH120.root",ROOT.kGray+2, linestyle=2, legEntry=False)
plot_014_full = SignPlot(-1, 1, 100, "BDT_1_4_full", "BDT 1 cut tune2, mva & #eta", "output/scan_0.1.4/", "higgsCombine_dnn_option0.1.4_full_", ".Significance.mH120.root", ROOT.kBlack, legEntry=False)


plots_bdt1 = [plot_011_full, plot_011_mva]
plots_bdt1_tune = [plot_011_full, plot_011_mva, plot_012_full, plot_012_mva, plot_013_full, plot_013_mva, plot_014_full, plot_014_mva]
...
plot_113_mva = SignPlot(1, 3, 200, "DNN_1_3_mva", "DNN 1 cut tune, only mva", "output/scan_1.1.3/",  "higgsCombine_dnn_option1.1.3_mva_", ".Significance.mH120.root",ROOT.kPink+10, 2, legEntry=False)
plot_113_full = SignPlot(1, 3, 200, "DNN_1_3_full", "DNN 1 cut tune, mva & #eta", "output/scan_1.1.3/",  "higgsCombine_dnn_option1.1.3_full_", ".Significance.mH120.root", ROOT.kRed, legEntry=False)


plots_dnn1 = [ plot_111_full,  plot_111_mva]
plots_dnn1_tune = [ plot_111_full,  plot_111_mva, plot_112_full,  plot_112_mva, plot_113_full,  plot_113_mva ]
