...
plot_2017_nuis_0p1_new = SignPlot("plot_2017_psweights_0p1_new", "%s 3Gaus corrected"%args.process, "/home/dkondra/Hmumu_analysis/Hmumu_ML/cut_optimization/2cat_scan/output/%s_2017_psweights_nuis_0p1_new/"%args.process, ROOT.kBlack)
