...
plots = [plot_2016, plot_2017, plot_2018, plot_2018_test]
...
plots_nuis = [plot_2016_nuis, plot_2017_nuis, plot_2018_nuis, plot_2018_test_nuis]
...
legend.Draw()
canvas.Print("/home/dkondra/Hmumu_analysis/Hmumu_ML/cut_optimization/2cat_scan/significance_%s_test.png"%args.process)
canvas.SaveAs("/home/dkondra/Hmumu_analysis/Hmumu_ML/cut_optimization/2cat_scan/significance_%s_test.root"%args.process)
